...
public class AdminPanel extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        checkStockButton.setBackground(new java.awt.Color(255, 0, 51));
        ...
        billingButton.setBackground(new java.awt.Color(255, 0, 51));
        ...
        mModel.setCaretColor(new java.awt.Color(204, 0, 0));
        ...
        mPhotoPath.setBackground(new java.awt.Color(255, 255, 255));
        mPhotoPath.setFont(new java.awt.Font("Roboto", 0, 14)); // NOI18N
        mPhotoPath.setForeground(new java.awt.Color(204, 0, 0));
        ...
        updatePanel.add(mPhotoPath, new org.netbeans.lib.awtextra.AbsoluteConstraints(880, 430, 210, 30));
        ...
        updatePanel.add(selectedPhoto, new org.netbeans.lib.awtextra.AbsoluteConstraints(900, 200, 230, 210));

        photoSelection.setBackground(new java.awt.Color(204, 0, 0));
        ...
        updatePanel.add(photoSelection, new org.netbeans.lib.awtextra.AbsoluteConstraints(1090, 430, 50, 30));
    ...
    private void billingButtonMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_billingButtonMouseReleased
        // TODO add your handling code here:
        billingButton.setBackground(new Color(255,0,51));
    ...
    private void checkStockButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_checkStockButtonActionPerformed
            ...
            ArrayList<ProductList> list = FruitsDB.checkStock();
    ...
    private void checkStockButtonMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_checkStockButtonMouseReleased
        // TODO add your handling code here:
        checkStockButton.setBackground(new Color(255,0,51));
    ...
    private void updateButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateButtonActionPerformed
            updateButton.setBackground(new Color(255,0,51));
            cardAdminParentLayout.removeAll();
    ...
    private void jLabel1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel1MouseClicked
        // TODO add your handling code here:
        jLabel1.setBackground(new Color(255,0,51));
    ...
    private void LogInButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_LogInButtonActionPerformed
        // TODO add your handling code here:
        try{
            if(mCat.getSelectedItem().equals("Vegetables")){
            if(!path.equals(""))
                VegetablesDB.insertIntoVegetablesDB(mBrand.getText(), mModel.getText(), Integer.parseInt(mPrice.getText()), 
                        Integer.parseInt(mQty.getText()), mDescription.getText(), path);
        }
        
        else if(mCat.getSelectedItem().equals("Fruits")){
            if(!path.equals(""))
                FruitsDB.insertIntoFruitsDB(mBrand.getText(), mModel.getText(), Integer.parseInt(mPrice.getText()), 
                        Integer.parseInt(mQty.getText()), mDescription.getText(), path);
        }
        else if(mCat.getSelectedItem().equals("Dairy")){
            if(!path.equals(""))
                DairyDB.insertIntoDairyDB(mBrand.getText(), mModel.getText(), Integer.parseInt(mPrice.getText()), 
                        Integer.parseInt(mQty.getText()), mDescription.getText(), path);
        }
    ...
    private void updateStockButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateStockButtonActionPerformed
        // TODO add your handling code here:
        updateStockButton.setBackground(new Color(255,0,51));
        try{
            String model = stockUpdateModel.getText();
            int qty = Integer.parseInt(stockUpdateSetQty.getText());

            if(stockStatusCat.getSelectedItem().equals("Fruits")){
                FruitsDB.flag = true;
                FruitsDB.updateFruitsDB(model, qty);
            }

            else if(stockStatusCat.getSelectedItem().equals("Vegetables")){
                VegetablesDB.flag = true;
                VegetablesDB.updateVegetablesDB(model, qty);
            }

            else if(stockStatusCat.getSelectedItem().equals("Dairy")){
                DairyDB.flag = true;
                DairyDB.updateDairyDB(model, qty);
            }
    ...
    private void delEntryActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_delEntryActionPerformed
        ...
        if(delUpdateCat.getSelectedItem().equals("Fruits")){
            FruitsDB.delete(del);
        }
        else if(delUpdateCat.getSelectedItem().equals("Vegetables")){
            VegetablesDB.delete(del);
        }
        else if(delUpdateCat.getSelectedItem().equals("Dairy")){
            DairyDB.delete(del);
        }
