...
public class ProductInformation extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        productInfoBrand1.setForeground(new java.awt.Color(204, 0, 0));
        ...
        productInfoBrand4.setForeground(new java.awt.Color(204, 0, 0));
    ...
    private void addToCartActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addToCartActionPerformed
        ...
        if(Integer.parseInt(this.productInfoStock.getText())<Integer.parseInt(this.productQtyField.getText())){
            ...
            if(categoryChooser.equals("Vegetables"))
                    VegetablesDB.updateVegetablesDB(this.productInfoModel.getText(), qtyTester);
            else if(categoryChooser.equals("Dairy"))
                    DairyDB.updateDairyDB(this.productInfoModel.getText(), qtyTester);
            else if(categoryChooser.equals("Fruits"))
                    FruitsDB.updateFruitsDB(this.productInfoModel.getText(), qtyTester);
